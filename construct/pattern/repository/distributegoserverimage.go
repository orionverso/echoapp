...
var DistributeGoServerImageIds_DEV DistributeGoServerImageIds = DistributeGoServerImageIds{
	DistributeModelIds: DistributeModelIds{
		ConstructId:  jsii.String("DistributeGoServerImage-resource-construct-dev"),
		RepositoryId: jsii.String("DistributeGoServerImage-resource-repository-dev"),
	},
}
...
var DistributeGoServerImageIds_PROD DistributeGoServerImageIds = DistributeGoServerImageIds{
	DistributeModelIds: DistributeModelIds{
		ConstructId:  jsii.String("DistributeGoServerImage-resource-construct-prod"),
		RepositoryId: jsii.String("DistributeGoServerImage-resource-repository-prod"),
	},
}
