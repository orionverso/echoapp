...
// DEFAULT
func TestSynthApiGatewayWithLambdaProxyIntegrated_DEFAULT(t *testing.T) {
	defer func() {
	...
	NewApiGatewayWithLambdaProxyIntegrated(stack, jsii.String("TestSynth_DEFAULT"), nil)

	assertions.Template_FromStack(stack, nil)
}

// DEVELOPMENT
func TestSynthApiGatewayWithLambdaProxyIntegrated_DEV(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Fail()
	...
	NewApiGatewayWithLambdaProxyIntegrated(stack, jsii.String("TestSynth_DEV"), &ApiGatewayWithLambdaProxyIntegratedProps_DEV)
...
// PRODUCTION
func TestSynthApiGatewayWithLambdaProxyIntegrated_PROD(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Fail()
	...
	NewApiGatewayWithLambdaProxyIntegrated(stack, jsii.String("TestSynth_PROD"), &ApiGatewayWithLambdaProxyIntegratedProps_PROD)
