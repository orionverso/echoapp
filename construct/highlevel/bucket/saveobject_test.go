...
// DEFAULT
func TestSynthSaveObject_DEFAULT(t *testing.T) {
	defer func() {
	...
	NewSaveObject(stack, jsii.String("TestSynth_DEFAULT"), nil)

	assertions.Template_FromStack(stack, nil)
}

// DEVELOPMENT
func TestSynthSaveObject_DEV(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Fail()
	...
	NewSaveObject(stack, jsii.String("TestSynth_DEV"), &SaveObjectProps_DEV)
...
// PRODUCTION
func TestSynthSaveObject_PROD(t *testing.T) {
	defer func() {
		if err := recover(); err != nil {
			t.Fail()
	...
	NewSaveObject(stack, jsii.String("TestSynth_PROD"), &SaveObjectProps_PROD)
